...
build_runner: ## run build runner to generate files
	@echo "╠  Running build to generate files"
	@dart run build_runner build --delete-conflicting-outputs

build_runner_watch: ## run build runner in watch mode (keeps running)
	@echo "╠  Running build to generate files (watch mode)"
	@dart run build_runner watch --delete-conflicting-outputs

generate_splash: ## Generate splash screen
