...
class FavoriteRepositoryImpl implements FavoriteRepository {
  ...
  Future<Either<Failure, void>> addToFavorites({
    ...
    try {
      final response = await favoriteRemoteDataSource.addToFavorites(
        station: station,
      );
  ...
  Future<Either<Failure, void>> removeFromFavorites({
    ...
    try {
      final response = await favoriteRemoteDataSource.removeFromFavorites(
        station: station,
      );
      return Right(response);
    } on AppExceptions catch (e) {
  ...
  Future<Either<Failure, List<StationEntity>>> getFavoriteStations({
    ...
    try {
      final response = await favoriteRemoteDataSource.getFavoriteStations(
        skip: skip,
        limit: limit,
      );
      return Right(response);
